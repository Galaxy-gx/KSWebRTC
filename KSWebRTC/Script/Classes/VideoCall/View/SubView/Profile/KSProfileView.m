...
- (void)initKit {
    ...
    titleLabel.frame = CGRectMake(0, CGRectGetMaxY(iconView.frame) + _configure.titleOffst,
    ...
    UILabel *descLabel = [UILabel ks_labelWithTextColor:[UIColor ks_white]
                                              ...
                                              alignment:NSTextAlignmentCenter];
    descLabel.frame = CGRectMake(0, CGRectGetMaxY(titleLabel.frame) + _configure.descOffst,
