...
- (void)initKit {
    ...
    int bar_w = 234;
    int bar_h = 46;
    KSMeetingBarView *meetingBarView = [[KSMeetingBarView alloc] initWithFrame:CGRectMake((self.bounds.size.width - bar_w)/2, CGRectGetMaxY(textField.frame), bar_w, bar_h)];
