...
typedef NS_ENUM(NSInteger, KSEventType) {
    ...
    KSEventTypeInConversationVolumeOpen,//会话中开启声音
    ...
    KSEventTypeMeetingThemeVolumeClose,//会议主题静音
    KSEventTypeMeetingThemeCameraOpen,//会议主题开启摄像机
    KSEventTypeMeetingThemeCameraClose,//会议主题关闭摄像机
    KSEventTypeMeetingThemeBluetoothOpen,//会议主题开启蓝牙
    KSEventTypeMeetingThemeBluetoothClose,//会议主题关闭蓝牙
