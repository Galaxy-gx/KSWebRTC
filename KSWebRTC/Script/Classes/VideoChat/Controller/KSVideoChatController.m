...
- (void)initializeKit {
    ...
    KSLocalView *localView = [[KSLocalView alloc] initWithFrame:CGRectMake(0, _topOffset, _kitWidth, _kitHeight) scale:KSScaleMake(9, 16) mode:KSContentModeScaleAspectFit callType:KSCallTypeManyVideo];
